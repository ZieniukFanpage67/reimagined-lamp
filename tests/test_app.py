...
def test_db():
    ...
    con.executescript("""CREATE TABLE Items(product_id INT NOT NULL PRIMARY KEY, product_name VARCHAR(99), quantity_available int, price float);
                    ...
                    INSERT INTO Orders ("order_id", "client_id", "product_id", "quantity", "total_amount_paid", "created_at") VALUES (1, 343434, 2013312, 2, 437.84, '2025-04-30');
                    INSERT INTO Orders ("order_id", "client_id", "product_id", "quantity", "total_amount_paid", "created_at") VALUES (1, 343434, 497870, 3, 269.97, '2025-04-30');
                    INSERT INTO Orders ("order_id", "client_id", "product_id", "quantity", "total_amount_paid", "created_at") VALUES (1, NULL, NULL, NULL, 707.81, NULL);
